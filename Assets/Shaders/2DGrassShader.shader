...
Shader "2DGrassShader"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float dotResult87 = dot( ifLocalVar85 , UnpackNormal( tex2D( _NormalMap1, uv_TexCoord16 ) ) );
...
/*ASEBEGIN
Version=18100
7;7;1352;700;1544.112;-346.5891;1.381667;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-2053.939,-66.12761;Inherit;False;Property;_Float0;Float 0;2;0;Create;True;0;0;False;0;False;0.1;0.025;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=3BA0C51800A70A27B377856B644FD5FA12A460FD