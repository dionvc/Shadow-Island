...
public class Alliance
{
    ...
    public Vector2 spawnPoint; //used for respawning if necessary (mainly for player alliances, but could be for some sort of enemy)
    ...
    {
        if(hostileTowards == null)
        {
            hostileTowards = new List<int>();
        }
